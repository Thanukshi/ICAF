...
.was-validated .form-control:valid, .form-control.is-valid {
  ...
  background-image: url("5f26aa70a06484fda2b9c460d00e44ed");
...
.was-validated .custom-select:valid, .custom-select.is-valid {
  ...
  background: url("ac7104a5f872eca5a5ae29aee8d70fd1") no-repeat right 0.75rem center/8px 10px, url("5f26aa70a06484fda2b9c460d00e44ed") #fff no-repeat center right 1.75rem/calc(0.75em + 0.375rem) calc(0.75em + 0.375rem); }
...
.was-validated .form-control:invalid, .form-control.is-invalid {
  border-color: #dc3545;
  padding-right: calc(1.5em + 0.75rem);
  background-image: url("03890a7c533e10d785abc890c7b92cd1");
  background-repeat: no-repeat;
  background-position: center right calc(0.375em + 0.1875rem);
  background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem); }
...
.was-validated .custom-select:invalid, .custom-select.is-invalid {
  border-color: #dc3545;
  padding-right: calc((1em + 0.75rem) * 3 / 4 + 1.75rem);
  background: url("ac7104a5f872eca5a5ae29aee8d70fd1") no-repeat right 0.75rem center/8px 10px, url("03890a7c533e10d785abc890c7b92cd1") #fff no-repeat center right 1.75rem/calc(0.75em + 0.375rem) calc(0.75em + 0.375rem); }
...
.custom-checkbox .custom-control-input:checked ~ .custom-control-label::after {
  background-image: url("00d29f672f13e1543f1ec65292397413"); }
.custom-checkbox .custom-control-input:indeterminate ~ .custom-control-label::before {
  border-color: #007bff;
  background-color: #007bff; }
.custom-checkbox .custom-control-input:indeterminate ~ .custom-control-label::after {
  background-image: url("5989fa22f98c698013b04242c95c7648"); }
...
.custom-radio .custom-control-input:checked ~ .custom-control-label::after {
  background-image: url("30856200a2648806229e0ed2db5f0b30"); }
...
.custom-select {
  ...
  color: #495057;
  vertical-align: middle;
  background: url("ac7104a5f872eca5a5ae29aee8d70fd1") no-repeat right 0.75rem center/8px 10px;
  background-color: #fff;
  border: 1px solid #ced4da;
  border-radius: 0.25rem;
  -webkit-appearance: none;
...
.navbar-light .navbar-toggler-icon {
  background-image: url("d20b9275145a1b973e091e6788d3215b"); }
...
.navbar-dark .navbar-toggler-icon {
  background-image: url("b15d40fbf84a6e28a0becc56e5b89b56"); }
...
.carousel-control-prev-icon {
  background-image: url("773faeee5a0e02640ffafd4b0b32a9e4"); }
.carousel-control-next-icon {
  background-image: url("55819c5f8525f1f27a812ab47806f9bc"); }
.carousel-indicators {
  position: absolute;
  right: 0;
  bottom: 0;
...
.ftco-navbar-light .navbar-nav > .nav-item.cta > a {
    ...
    border-radius: 5px; }
.ftco-navbar-light .navbar-nav > .nav-item.cta > input{
    background: #39E30D;
    color: #fff;
    -webkit-border-radius: 5px;
    -moz-border-radius: 5px;
...
.ftco-search .nav-pills .nav-link:after {
        ...
        border-color: #39E30D transparent transparent transparent;
        opacity: 0; }
